...
import io.schinzel.basicutils.crypto.cipherlibrary.CipherLibrary;
...
public class CipherLibrarySample {
    ...
    public static void main(String[] args) {
        ...
        CipherLibrary cipherLibrary = CipherLibrary.builder()
                .addCipher(1, new Aes256("G2Ed3Zs6qDAft8Az7268BE9bWbAzXm2q"))
                .addCipher(2, new Aes256("uhgZxYLKn92w2B2ZFUtT2y98Z9K89MmX"))
                .addCipher(3, new Aes256("et4CgMZd99zPodK7QnLDGMV643GE94Q8"))
                .build();
