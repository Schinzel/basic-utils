...
public class CipherLibrarySingleton {
    private CipherLibrary mLibrary;
    private CipherLibrary.CipherLibraryBuilder mBuilder = CipherLibrary.builder();

    static class Holder {
        static final CipherLibrarySingleton INSTANCE = new CipherLibrarySingleton();
    }
