...
class HashLibrarySingleton {
    private HashLibrary mLibrary;
    private HashLibrary.HashLibraryBuilder mBuilder = HashLibrary.builder();

    static class Holder {
        final static HashLibrarySingleton INSTANCE = new HashLibrarySingleton();
    }
